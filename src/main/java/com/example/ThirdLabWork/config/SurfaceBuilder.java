...
public class SurfaceBuilder {
    ...
    public SurfaceBuilder setFullMoon() {
        environment = new FullMoon(environment);
        return this;
    }

    public SurfaceBuilder setHalfMoon() {
        environment = new HalfMoon(environment);
        return this;
    }
    ...
    public SurfaceBuilder setOpenSpace() {
        environment.setColor(EnvironmentColor.SPACE_LIGHT);
        return this;
    }
